...
CREATE TABLE IF NOT EXISTS bloodDb.patients (
    ...
    "recieviedBloodMl" double precision,
    "surname" character varying(25) NOT NULL,
    "telephoneNumber" character varying(25) NOT NULL,
    "neededBloodMl" double precision
);
CREATE TABLE IF NOT EXISTS bloodDb.hospitals (
    "id" SERIAL UNIQUE NOT NULL PRIMARY KEY,
    "address" character varying(60) NOT NULL,
    "postcode" character varying(20) NOT NULL,
    "name" character varying(25) NOT NULL,
...
CREATE TABLE IF NOT EXISTS bloodDb.blood (
    "type" character varying(2) NOT NULL,
    "isRhesus" boolean NOT NULL,
    "id" SERIAL UNIQUE NOT NULL PRIMARY KEY,
    "fullName" character varying(4) NOT NULL
);
CREATE TABLE IF NOT EXISTS bloodDb.transfusions (
    "id" SERIAL UNIQUE NOT NULL PRIMARY KEY,
    ...
    "bloodTransferedMl" double precision NOT NULL
);
CREATE TABLE IF NOT EXISTS bloodDb.blood_blood (
    "id" SERIAL UNIQUE NOT NULL PRIMARY KEY,
...
ADD FOREIGN KEY ("hospitalId") REFERENCES bloodDb.hospitals ("id") NOT VALID;
ALTER TABLE bloodDb.donors
ADD FOREIGN KEY ("bloodTypeId") REFERENCES bloodDb.blood ("id") NOT VALID;
ALTER TABLE bloodDb."blood_blood"
ADD FOREIGN KEY ("donorBloodId") REFERENCES bloodDb."blood"("id") NOT VALID;
ALTER TABLE bloodDb."blood_blood"
ADD FOREIGN KEY ("patientBloodId") REFERENCES bloodDb."blood"("id") NOT VALID;
ALTER TABLE bloodDb.patients
ADD FOREIGN KEY ("hospitalId") REFERENCES bloodDb.hospitals ("id") NOT VALID;
ALTER TABLE bloodDb.transfusions
ADD FOREIGN KEY ("patientId") REFERENCES bloodDb.patients ("id") NOT VALID;
ALTER TABLE bloodDb.transfusions
ADD FOREIGN KEY ("donorId") REFERENCES bloodDb.donors ("id") NOT VALID;
ALTER TABLE bloodDb.transfusions
ADD FOREIGN KEY ("hospitalId") REFERENCES bloodDb.hospitals ("id") NOT VALID;

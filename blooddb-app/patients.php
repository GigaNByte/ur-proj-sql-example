...
<div class="card has-table">
    <div class="card-header">
        ...
        <form method="POST" action="patients.php" class="card-header-icon  flex flex-row  mx-5">
        ...
        <a href="./patients.php" class="card-header-icon">
    ...
    <div class="card-content">
        ...
        $patients = Patient::fetchAll(10, $page, $orderBy, $order);
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Hospital</th>
                    <th>Recievied Blood Ml</th>
                    <th>Needed Blood Ml</th>
                    <th>Action</th>
                </tr>
            </thead>
            <tbody>
                ...
                foreach ($patients as $patient) {
                    ...
                    echo "<td>" . $patient->getBloodType() . "</td>";
                    echo "<td>" . $patient->getAddress() . "</td>";
                    echo "<td>" . $patient->getPostcode() . "</td>";
                    echo "<td>" . $patient->getTelephone() . "</td>";
                    echo "<td>" . $patient->getHospital() . "</td>";
                    echo "<td>" . $patient->getRecievedBloodMl() . "</td>";
                    echo "<td>" . $patient->getNeededBloodMl() . "</td>";
                ?>
                <td class="actions-cell">
                    <div class="buttons right nowrap">
                        <button class="button small blue --jb-modal" data-target="sample-modal-2" type="button">
                            <a href="<?php echo $patient->getEditLink() ?>">
                                <span class="icon"><i class="fa-solid fa-pen"></i></span>
                            </a>
                        </button>
                        <button class="button small red --jb-modal" data-target="sample-modal" type="button">
                            <a href="<?php echo $patient->getDeleteLink() ?>">
                ...
                echo Patient::getPaginationLinks(10, $page);
                echo '</div>';
                echo '</div>';
                ?>
    </div>
                ...
                <form action="createPatient.php" method="POST">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label for="blood_type_id" class="pr-5">Blood Type</label>
                            <select name="blood_type_id" class="input">
                                <?php
                                foreach (Blood::fetchAll() as $bloodType) {
                                    if ($bloodType->getId() == $patient->getBloodTypeId()) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="needed_blood_ml" class="input" placeholder="Needed Blood Ml">
                        </td>
                        <td>
